      ...
      <div className="flex flex-col items-center w-full max-w-screen-md p-6 pb-6 bg-white rounded-lg shadow-xl sm:p-8">
        ...
        <div className="flex items-end flex-grow w-full mt-2 space-x-2 sm:space-x-3">
          ...
          <div className="relative flex flex-col items-center flex-grow pb-5 group">
            ...
            <div className="relative flex justify-center w-full h-10 bg-sky-200"></div>
            <div className="relative flex justify-center w-full h-8 bg-sky-300"></div>
            <div className="relative flex justify-center w-full h-20 bg-sky-400"></div>
          ...
          <div className="relative flex flex-col items-center flex-grow pb-5 group">
            ...
            <div className="relative flex justify-center w-full h-12 bg-sky-200"></div>
            <div className="relative flex justify-center w-full h-8 bg-sky-300"></div>
            <div className="relative flex justify-center w-full h-24 bg-sky-400"></div>
          ...
          <div className="relative flex flex-col items-center flex-grow pb-5 group">
            ...
            <div className="relative flex justify-center w-full h-12 bg-sky-200"></div>
            <div className="relative flex justify-center w-full h-16 bg-sky-300"></div>
            <div className="relative flex justify-center w-full h-20 bg-sky-400"></div>
          ...
          <div className="relative flex flex-col items-center flex-grow pb-5 group">
            ...
            <div className="relative flex justify-center w-full h-12 bg-sky-200"></div>
            <div className="relative flex justify-center w-full h-10 bg-sky-300"></div>
            <div className="relative flex justify-center w-full h-24 bg-sky-400"></div>
          ...
          <div className="relative flex flex-col items-center flex-grow pb-5 group">
            ...
            <div className="relative flex justify-center w-full h-12 bg-sky-200"></div>
            <div className="relative flex justify-center w-full h-12 bg-sky-300"></div>
        ...
        <div className="flex w-full mt-3">
          <div className="flex items-center ml-auto">
            ...
            <span className="ml-1 text-xs font-medium">Royalties</span>
          </div>
          <div className="flex items-center ml-4">
            <span className="block w-4 h-4 bg-sky-300"></span>
            <span className="ml-1 text-xs font-medium">Subscriptions sold</span>
          </div>
          <div className="flex items-center ml-4">
            <span className="block w-4 h-4 bg-sky-200"></span>
            <span className="ml-1 text-xs font-medium">Plugins sold</span>
          </div>
        </div>
      </div>
    </>
